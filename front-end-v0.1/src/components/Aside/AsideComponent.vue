<template>
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <router-link v-if="canViewCalendar" to="/calendario" class="nav-item">
        <i class="bi bi-calendar-fill"></i>
        <span>Calendário</span>
      </router-link>
      <router-link v-if="canViewProposals" to="/propostas" class="nav-item">
      ...
      <router-link v-if="canViewContracts" to="/contratos" class="nav-item">
        <svg width="20" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <router-link v-if="canViewDocuments" to="/documentos" class="nav-item">
        <svg width="18" height="20" viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <router-link v-if="canViewCompanies" to="/empresas" class="nav-item">
      ...
      <router-link v-if="canViewUsers" to="/usuarios" class="nav-item">
      ...
      <router-link v-if="canViewAuthorizations" to="/autorizacoes" class="nav-item">
